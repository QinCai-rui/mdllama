...
from .chat_edit import ChatEdit
from .chat_export import ChatExport, slugify
...
from .utils import check_ollama, is_up_to_date
...
class MDLlamaApp(App):
    ...
    async def load_mcp(self):
        # MCP support removed for simplicity in mdllama
        pass
...
# Don't create app instance here - will be created in main.py
